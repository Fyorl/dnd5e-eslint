...
export const recommended = [
  {
    ...
    plugins: { dnd5e, jsdoc, perfectionist, "@stylistic": stylistic },
    rules: {
      ...
      "dnd5e/jsdoc-no-spaces-around-optional-param-equals": "warn",
      "dnd5e/no-spaces-around-default-param-equals": "warn",
      "dnd5e/require-arrow-braces": "warn",
      "dnd5e/require-method-separator": "warn",
      "dnd5e/sort-object-keys": "warn",
      "dnd5e/space-in-control-flow-parens": "warn",
      "dot-notation": "warn",
      eqeqeq: ["warn", "smart"],
